...
To run this project on a Google Compute Engine, I followed these steps:
   ...
   - You can access the frontend from your browser via `http://<your_instance_IP>:3000/?userid=<some_user_id>&sessionnum=1`. `sessionnum` determines which session is started. Earlier sessions need to be completed by a user to be able to access later ones.
   - Open the chat here:
